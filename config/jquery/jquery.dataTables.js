	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text"  class=\'ui-widget-content ui-corner-all\'/>') :
			  sSearchStr==="" ? '<input type="text" class=\' ui-widget-content ui-corner-all\'/>' : sSearchStr+' <input type="text" class=\' ui-widget-content ui-corner-all\'/>';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select class="ui-widget-content ui-corner-all" size="1" '+sName+'>';
			var i, iLen;
